...
//     { title: "Total Favorites", value: "842",                icon: BiAddToQueue,     color: "text-rose-600",  bg: "bg-rose-100" },
//     { title: "Total Engagement", value:"1",              icon: BiHeart,color: "text-purple-600",bg: "bg-purple-100" },
//   ];
...
//       {/* 1. Header Section */}
//       <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl shadow-sm">
//         <div>
...
//             className="p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow"
//           >
...
//           <Link
//             href="/dashboard/seller/myRecipe"
...
import { HiOutlineArrowRight } from "react-icons/hi";
import { getCompanyRecipe, getSellerStats } from "@/lib/api";
import ViewRecipeModal from "@/app/components/dashboard/viewModalofSeller";
import EditRecipeModal from "@/app/components/dashboard/editModalofSeller";
import DeleteRecipeModal from "@/app/components/dashboard/deleteModalofSeller";
...
export default function SellerDashboardHomepage() {
  ...
  const stats = [
    { title: "Active Recipes",   value: recipes.length || "0",                       icon: BiBookOpen,   color: "text-blue-600",   bg: "bg-blue-100" },
    { title: "Total Favorites",  value: formatCount(sellerStats.totalFavorites),      icon: BiBookmark,      color: "text-purple-600",   bg: "bg-purple-100" },
